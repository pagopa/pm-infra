module "admin-panel" {
  ...
  app_settings = {
    ...
    APPLICATIONINSIGHTS_CONNECTION_STRING           = var.appinsight_name != "" ? data.azurerm_application_insights.appinsight[0].connection_string : var.appinsight_connection_string
